            ...
            <div className='flex flex-col text-center'>
                ...
                <ul className='mt-4 min-h-32'>
                    {menuNavigator.map((obj) => {
                        return <li className='uppercase p-3 text-slate-900 font-semibold active:bg-gray-500'>
                            <ScrollLink to={obj.reference} smooth={true} duration={800}>{obj.name}</ScrollLink>
                        </li>
                    })}
                </ul>
            </div>
