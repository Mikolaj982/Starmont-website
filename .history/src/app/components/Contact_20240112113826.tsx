...
import { PhoneIcon, MapPinIcon, InboxIcon } from '@heroicons/react/20/solid';
        ...
        <div id='contact' className='bg-[#88D78B] h-[100vh]'>
            <div className='flex justify-end flex-col column h-[100vh] p-8'>
                <div className='mb-24'>
                    ...
                    <span className='flex'><PhoneIcon className='h-6 mr-2 text-primary' /><p className='text-primary'>+48 XXX XXX XXX</p></span>
                    <span className='flex'><InboxIcon className='h-6 mr-2 text-primary' /><p className='text-primary'>example@gmail.com</p></span>
                </div>
