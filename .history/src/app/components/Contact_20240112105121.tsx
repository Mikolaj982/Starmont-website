    ...
    return (
        <div id='contact' className='bg-[#88D78B] h-[100vh]'>
            <div className='flex justify-end flex-col column h-[100vh] p-8'>
                <div>
                    <h2>Kontakt</h2>
                    <span className='flex mb-3'><MapPinIcon className='h-6 mr-1' /><p>Dziurów, ul. Słoneczna 25, 27-230</p></span>
                    <span className='flex'><PhoneIcon className='h-6' /><p>+48 XXX XXX XXX</p></span>
                </div>
