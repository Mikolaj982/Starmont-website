        ...
        <div id='contact' className='bg-[#88D78B] h-[100vh]'>
            <div className='flex justify-end flex-col column h-[100vh] p-8'>
                <div className='text-textPrimaryColor'>
                    <h2 className='text-PrimaryTextColor'>Kontakt</h2>
                    <span className='flex mb-3'><MapPinIcon className='h-6 mr-2' /><p>Dziurów, ul. Słoneczna 25, 27-230</p></span>
                    <span className='flex'><PhoneIcon className='h-6 mr-2' /><p>+48 XXX XXX XXX</p></span>
                </div>
                <div className='flex justify-between flex-col mb-'>
                    <h3>Lokalizacja:</h3>
