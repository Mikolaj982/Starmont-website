        ...
        <div id='contact' className='bg-[#88D78B] h-[100vh]'>
            <div className='flex justify-end flex-col column h-[100vh] p-8'>
                <div>
                    ...
                    <span className='flex mb-3'><MapPinIcon className='h-6 mr-2' /><p className='text-secondary-text-color'>Dziurów, ul. Słoneczna 25, 27-230</p></span>
                    <span className='flex'><PhoneIcon className='h-6 mr-2' /><p className='text-secondary-text-color'>+48 XXX XXX XXX</p></span>
                </div>
