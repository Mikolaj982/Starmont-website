...
const NavigationMenu: React.FC<NavigationMenuProps> = ({ setIsOpen, isOpen }) => {
    ...
    return (
        <div className={`top-0 bg-white-200 backdrop-blur-sm backdrop-brightness-150 w-[100vw] fixed z-20 transform transition-transform duration-1000 ease-in-out ${isOpen ? 'translate-y-0' : '-translate-y-72'}`}>
